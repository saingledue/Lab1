...
# tables 
classes_db = [['RAIK_181H', '9749', 'FOUNDATIONS_OF_ACCOUNTING', 'Trucke', '4', 'MW', '10:30AM-11:45AM', 'KAUF_112'],
['RAIK_182H', '9746', 'FOUNDATIONS_OF_ECONOMICS', 'Rosenbaum', '4', 'MWF', '12:30PM-2:20PM', 'KAUF_112'],
['RAIK_184H', '9733', 'SOFTWARE_DEVELOPMENT_ESSENTIALS', 'Valentine', '4', 'TR', '11:00AM-12:50PM', 'KAUF_112'],
['RAIK_185H', '9762', 'FOUNDATIONS_OF_LEADERSHIP_I', 'Valentine', '1', 'F', '10:30AM-11:45AM', 'KAUF_112'],
['RAIK_185H', '9762', 'FOUNDATIONS_OF_LEADERSHIP_I', 'Mackalski', '1', 'F', '10:30AM-11:45AM', 'KAUF_112'],
['RAIK_186H', '9809', 'FOUNDATIONS_OF_LEADERSHIP_II', 'Pressler', '1', 'W', '3:30PM-4:45PM', 'KAUF_112'],
['RAIK_186H', '9809', 'FOUNDATIONS_OF_LEADERSHIP_II', 'Nelson', '1', 'W', '3:30PM-4:45PM', 'KAUF_112'],
['RAIK_284H', '19875', 'SOFTWARE_ENGINEERING_IV', 'Firestone', '4', 'TR', '3:30PM5:20PM', 'KAUF_110'],
['RAIK_288H', '9785', 'HONORS_BUSINESS_WRITING', 'Aldrich', '3', 'MW', '5:00PM-6:15PM', 'KAUF_112'],
['RAIK_341H', '9810', 'MARKETING', 'Mackalski', '3', 'TR', '9:30AM-10:45AM', 'KAUF_112'],
['RAIK_370H', '9758', 'DATA_AND_MODELS_II', 'Keck', '3', 'MWF', '10:30AM-11:20AM', 'KAUF_110', ''],
['RAIK_371H', '9767', 'DATA_&_MODELS_III', 'Keck', '3', 'TR', '9:30AM-10:45AM', 'KAUF_110', ''],
['RAIK_372H', '9763', 'BUSINESS_LAW', 'Firestone', '3', 'MW', '11:30AM-12:20PM', 'KAUF_110', ''],
['RAIK_372H', '9763', 'BUSINESS_LAW', 'Perlman', '3', 'MW', '11:30AM-12:20PM', 'KAUF_110', ''],
['RAIK_402H', '9734', 'RAIK_DESIGN_STUDIO_II', 'Antonson', '3', 'TR', '2:00PM-3:15PM', 'KAUF_GH'],
['RAIK_404H', '9759', 'RAIK_DESIGN_STUDIO_IV', 'Antonson', '3', 'TR', '2:00PM-3:15PM', 'KAUF_GH'],
['RAIK_476H', '9811', 'BUSINESS_POLICIES_AND_STRATEGIES', 'Beck', '3', 'TR', '11:00AM-12:15PM', 'KAUF_110']]
...
@app.route('/api/v1/Lab1/resources/spring/all', methods=['GET'])
@cross_origin()
def api_all():
    return jsonify(classes_db)

@app.route('/api/v1/Lab1/resources/spring/professor', methods=['GET'])
@cross_origin()
def prof_call():
...
@app.route('/api/v1/Lab1/resources/spring/credit', methods=['GET'])
@cross_origin()
def cred_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/Lab1/resources/spring/days', methods=['GET'])
@cross_origin()
def days_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/Lab1/resources/spring/room', methods=['GET'])
@cross_origin()
def room_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/Lab1/resources/spring/time', methods=['GET'])
@cross_origin()
def time_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
